...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      firstName: 'Andrew Ebert',
      lastName: 'Sophia Christiansen',
      name: 'Noel Littel',
      username: 'Dillan.Erdman9',
      password: 'DI_8N0nSzCqKkgk',
      email: 'Earnest_Rolfson@gmail.com',
      userType: 968,
      image: 'Shoes',
      mobileNo: '(447) 800-6056',
      resetPasswordLink: {},
      loginRetryLimit: 535,
      loginReactiveTime: '2025-10-14T19:26:23.903Z',
      id: '6793de786404b3021093af20'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'firstName':'Miss Charles Kovacek',
        'lastName':'Omar Wisoky',
        'name':'Seth Deckow',
        'username':'Malika69',
        'password':'ziw4rpGDcOdXDof',
        'email':'Sherman82@hotmail.com',
        'userType':authConstant.USER_TYPES.User,
        'image':'Argentine',
        'mobileNo':'(378) 024-1209',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Sherman82@hotmail.com', });
