...
beforeAll(async function (){
  try {
    ...
    const dbInstance = client.db('todos_test');

    const user = dbInstance.collection('users');
    insertedUser = await user.insertOne({
      firstName: 'Esther Tromp',
      lastName: 'Rudolph Littel',
      name: 'Latoya Cartwright',
      username: 'Novella_Dickens49',
      password: 'Ga6Hnb3tnnXgpJC',
      email: 'Yadira99@yahoo.com',
      userType: 625,
      image: 'Legacy',
      mobileNo: '(662) 324-0527',
      resetPasswordLink: {},
      loginRetryLimit: 745,
      loginReactiveTime: '2026-01-06T04:59:40.187Z',
      id: '67939326669a2701ade6c4db'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'firstName':'Felix Metz',
        'lastName':'Emilio Altenwerth',
        'name':'Jerome Durgan',
        'username':'Sheldon.Cartwright',
        'password':'adXX6S8HkjbsvVt',
        'email':'Angelo.Gusikowski75@gmail.com',
        'userType':authConstant.USER_TYPES.User,
        'image':'Kazakhstan',
        'mobileNo':'(851) 143-3970',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Angelo.Gusikowski75@gmail.com', });
