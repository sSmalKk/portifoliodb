...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      firstName: 'Bryan Gutmann',
      lastName: 'Dr. Gladys Batz',
      name: 'Harriet Heller',
      username: 'Magnus.Berge',
      password: 'z41GROTdqo4Yhq4',
      email: 'Jack14@gmail.com',
      userType: 728,
      image: 'Incredible',
      mobileNo: '(850) 434-0266',
      resetPasswordLink: {},
      loginRetryLimit: 521,
      loginReactiveTime: '2026-01-19T15:51:31.112Z',
      id: '67939326669a2701ade6c497'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'firstName':'Santos Hegmann',
        'lastName':'Russell Stracke',
        'name':'Wilbur Abernathy',
        'username':'Clementina_Grady',
        'password':'YexnzHIkdl3SvbI',
        'email':'Dave_Heathcote29@yahoo.com',
        'userType':authConstant.USER_TYPES.User,
        'image':'national',
        'mobileNo':'(169) 843-4410',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Dave_Heathcote29@yahoo.com', });
